Meteor.methods
	'Deploy.newInstance': (name, email, domain) ->
		...
		unless domain.length > 2
			throw new Meteor.Error 'email-invalid', 'The domain is invalid. Please use at least 3 characters.'

		unless urlPattern.test domain
			throw new Meteor.Error 'email-invalid', 'The domain is invalid. Please use only lowercase letters, numbers, dots and dashes.'
